...
var generateRandArrayFromSubArray = function (subArray, a, b) {
  ...
  var commentsCount = getRandomInteger(a, Math.min(b, subArray.length));
  var indexComment;

  for (var j = 0; j < commentsCount; j++) {
    indexComment = getRandomInteger(0, copySubArray.length - 1);
...
var showGalleryOverlay = function (arr, elem) {
...
showGalleryOverlay(usersPhotos, 0);